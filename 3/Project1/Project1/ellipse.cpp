...
СEllipse::СEllipse( int cx, int cy, int spx, int spy, int r ) {
	centerx = cx;
	centery = cy;
	speedx = spx;
	speedy = spy;
...
void СEllipse::SetRect(RECT rect) {
	border = rect;
...
void СEllipse::DrawEllipse(HDC dc, HWND handle) {
